...
class Login(object):
    ...
    def __init__(self, username, password, security_token, version="47.0"):
...
def soap_login(username, password, security_token, version="47.0"):
    """
    ...
    """
    soap_url = "https://login.salesforce.com/services/Soap/u/" + version
    soap_headers = {
